...
<script>
    ...
    export default {
        ...
        methods:{
            async getOrder(){
                let resp = await api.get("screenings/"+this.$route.params.screeningID+"?projection=ScreeningSeats")
                this.screening = resp.data;
            }
        },
        data(){
            return {
